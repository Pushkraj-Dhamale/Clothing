...
const Infos = () => {
  ...
  return (
    <Box mt={10} p={2} >
      <Text p={5} textAlign='center' fontSize={30} fontWeight={300} color='#273E47.500' >My Informations</Text>
      <Box display='flex' flexDirection={{ base: 'column', md: 'row' }} >
        <Box width='100%' display='flex' flexDirection='column' alignItems='center'  >
          <Text p={5} textAlign='center' fontSize={22} fontWeight={500} color='#273E47.500' >Address</Text>
        ...
        <Box width='100%' display='flex' flexDirection='column' alignItems='center' >
          <Text p={5} textAlign='center' fontSize={22} fontWeight={500} color='#273E47.500' >Phone</Text>
          ...
          <Button mt={5} color='#273E47' onClick={onClickSave} >Save</Button>
        </Box>
      </Box>
    </Box>
  )
